...
@app.route('/datalake/insert_string',methods=['POST']) #api to insert a string in to mysql, returns unique id of the string
def insert_string():
...
@app.route('/datalake/get_string',methods=['GET']) #api to retrive text from datalake
def get_string():
...
@app.route('/datalake/pdf_upload',methods=['POST']) #api to upload pdf in mongodb
def pdf_upload():
...
@app.route('/datalake/download_pdf',methods=['GET']) #api to download pdf from datalake
def pdf_download():
...
@app.route('/datalake/image_download',methods=['GET'])  #api to download image from datalake
def image_download():
